...
public:
    ...
    ContainerElt* makeKickControls(UgenManager* p_kick, int x, int y) {
        ...
        container->pushChild(
            ugenUiEltFactory->makeAHREnvControls(
                L"Amp",
                (WavetableOp*)p_kick->getUgen("ampEnv"),
                10,
                10
            )
        );
        ...
        container->pushChild(
            ugenUiEltFactory->makeAHREnvScaleControls(
                L"Freq",
                (AHRExpEnvScale*)p_kick->getUgen("freqEnv"),
                200,
                10
            )
        );
    ...
    ContainerElt* makeSnareControls(UgenManager* p_snare, int x, int y) {
        ...
        container->pushChild(
            ugenUiEltFactory->makeAHREnvControls(
                L"Amp",
                (AHRExpEnvVca*)p_snare->getUgen("ampEnv"),
                10,
                10
            )
        );
    ...
    ContainerElt* makeBassControls(UgenManager* p_bass, int x, int y) {
        ...
        container->pushChild(
            ugenUiEltFactory->makeAHREnvControls(
                L"Amp",
                (WavetableOp*)p_bass->getUgen("ampEnv"),
                10,
                10
            )
        );
        ...
        container->pushChild(
            ugenUiEltFactory->makeAHREnvScaleControls(
                L"Mod",
                (WavetableOp*)p_bass->getUgen("modEnv"),
                200,
                10
            )
        );
